...
export default function GuestReviewPage() {
  ...
  const copy = language === "es"
    ? { title: "¿Cómo estuvo tu estadía?", verified: "Estadía verificada por Pin&Go", overall: "Experiencia general", public: "Cuéntales a futuros huéspedes sobre tu estadía", private: "Comentarios privados para el anfitrión (opcional)", submit: "Enviar evaluación", thanks: "Gracias por compartir tu experiencia.", received: "Tu evaluación ha sido recibida.", unavailable: "Evaluación no disponible", loading: "Cargando…", retry: "Intentar nuevamente", ratingsRequired: "Selecciona todas las calificaciones.", failed: "No pudimos enviar la evaluación.", earlyTitle: "Tu evaluación se habilitará después del checkout", earlyBody: "Podrás compartir tu experiencia a partir del", saveLink: "Conserva este correo de invitación a evaluar para volver cuando desees.", openUntil: "El enlace estará disponible hasta el", reopenTitle: "Reabre tu correo de invitación a evaluar", reopenBody: "Por tu seguridad, esta página no conserva el enlace privado después de abrirlo. Busca el correo de invitación a evaluar de Pin&Go y selecciona “Evaluar tu estadía” para regresar.", emailReminder: "Conserva el correo de invitación a evaluar. Si actualizas o cierras esta página, vuelve a abrir la evaluación desde ese correo." }
    : { title: "How was your stay?", verified: "Stay verified by Pin&Go", overall: "Overall experience", public: "Tell future guests about your stay", private: "Private feedback for the host (optional)", submit: "Submit review", thanks: "Thank you for sharing your experience.", received: "Your review has been received.", unavailable: "Review unavailable", loading: "Loading…", retry: "Try again", ratingsRequired: "Please select every rating.", failed: "Unable to submit review.", earlyTitle: "Your review will open after checkout", earlyBody: "You can share your experience starting", saveLink: "Keep this review invitation email so you can return whenever you like.", openUntil: "The link will remain available until", reopenTitle: "Reopen your review invitation email", reopenBody: "For your security, this page does not retain the private link after you open it. Find your Pin&Go review invitation email and select “Review your stay” to return.", emailReminder: "Keep your review invitation email. If you refresh or close this page, reopen the review from that email." };
