...
test("guest review page is private, bilingual and locked until checkout", () => {
  ...
  assert.match(guest, /Conserva este correo de confirmación/);
  assert.match(guest, /Keep this confirmation email/);
  assert.match(guest, /setRefreshAttempt\(\(current\) => current \+ 1\)/);
  ...
  assert.match(guest, /Reabre tu correo de confirmación/);
  assert.match(guest, /Reopen your confirmation email/);
